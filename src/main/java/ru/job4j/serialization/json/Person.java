...
public class Person {
    ...
    //    Объекты классов Person, Contact из урока «Формат JSON» являются POJO,
//    но для корректного преобразования в строку с помощью org.json к ним ещё необходимо добавить геттеры.
